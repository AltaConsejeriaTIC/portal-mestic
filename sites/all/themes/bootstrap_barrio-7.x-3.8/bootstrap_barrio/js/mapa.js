window.onload = function () {
            ...
            R.setStart();
            for(loc in bog) {
                var area = R.path(bog[loc]["path"]);
                    area.attr(attr);
                    area.attr({"fill":bog[loc]["color"]})
                    area.data("nombre",loc);
            ...
            function setLocalidadColor (colorSet, localidad) {
                ...
                var hex = $.isEmptyObject(colorSet[localidad]["color"]) ? colorSet["none"]["color"] : colorSet[localidad]["color"];
                return hex;
